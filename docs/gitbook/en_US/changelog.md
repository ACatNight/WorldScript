...
- Towns and safe zones can use `peaceful` to block PVP; wilderness or arenas can use `dangerous` to keep fighting enabled.
...
4. If town PVP should be blocked, stand in town and run `/ws protect test`.
